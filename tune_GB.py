# -*- coding: utf-8 -*-
"""
Created on Wed Dec  8 16:37:45 2021
...
space={'criterion':hp.choice('criterion',['friedman_mse', 'mse', 'mae']),
...
crit={0:'friedman_mse',1:'mse',2:'mae'}
...
trainedgb=GradientBoostingClassifier(criterion=crit[best['criterion']],
...
accuracy_score(y_test,predictiongb)